...
class Classifier_RESNET_COPY:
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        cov_n=keras.layers.Conv1D(filters=n_feature_maps, kernel_size=blocknum, padding='same')(input_layer)
...
#             block_attention=block_attention+block_data
...
# =============================================================================
        ...
        #W_time=W_Blocks_zero*blocksrem#（None*T*n_feature_maps）对应元素相乘
        W_time=W_Blocks_zero*cov_n#（None*T*n_feature_maps）对应元素相乘ljw
        O_seq=O_seq+W_time+cov_n #（None*T*n_feature_maps）
        
        
        #cov_v=keras.layers.Conv1D(filters=n_feature_maps, kernel_size=1, padding='valid')(input_layer)
        #O_seq=O_seq+W_time+cov_v
