...
class Self_Attention(Layer):
    ...
    def call(self, x):
        ...
        print("self.kernel[0].dtype",self.kernel[0].dtype)
...
x_train = sequence.pad_sequences(x_train, maxlen=maxlen)#数据预处理，短的补零，长的截断
...
S_inputs = Input(shape=(64,), dtype='int32')#每一个样本都是(64,)的列表
#S_inputs = Input(shape=(64,1), dtype='int32')#每一个样本都是(64,)的列表
